...
\added{This ensures we do not have an imbalance in the number of points in each class when training our model.}
...
\added{The larger the value of $\Delta G_m$, when summed over all relevant splits and averaged over all trees, the more important that particular feature is.}
